        ...
        switch (binding.descriptorType) {
          ...
          case VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE: {
            ...
            if (viewHandle) {
              ...
              descriptorInfo.image = m_common->dummyResources().imageViewDescriptor(binding.viewType, true);
            }
          } break;
          ...
          case VK_DESCRIPTOR_TYPE_STORAGE_IMAGE: {
            ...
            if (viewHandle) {
              ...
              descriptorInfo.image = m_common->dummyResources().imageViewDescriptor(binding.viewType, false);
            }
          } break;
          ...
          case VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER: {
            ...
            if (viewHandle) {
              ...
              descriptorInfo.image = m_common->dummyResources().imageSamplerDescriptor(binding.viewType);
            }
          } break;
          ...
          case VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER: {
            ...
            if (res.bufferView != nullptr) {
              ...
              descriptorInfo.texelBuffer = m_common->dummyResources().bufferViewDescriptor();
            }
          } break;
          ...
          case VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER: {
            ...
            if (res.bufferSlice.length()) {
              ...
              descriptorInfo.buffer = m_common->dummyResources().bufferDescriptor();
            }
          } break;
  ...
  void DxvkContext::updateVertexBufferBindings() {
    ...
    for (uint32_t i = 0; i < m_state.gp.state.il.bindingCount(); i++) {
      ...
      if (likely(m_state.vi.vertexBuffers[binding].length())) {
        ...
        buffers[i] = m_device->features().extRobustness2.nullDescriptor ? VK_NULL_HANDLE : m_common->dummyResources().bufferHandle();
        offsets[i] = 0;
        lengths[i] = 0;
        strides[i] = 0;
      }
